...
# - 비동기 드라이바(asyncpg)가 아닌 동기 드라이버(psycopg2)를 사용해야 오류가 발생하지 않음
# -------------------------
DB_URL="postgresql+psycopg2://todo_user:1234@localhost/todo_db"

# -------------------------
# SQLAlchemy의 동기 엔진 생성
# * create_engine()은 동기용이므로 psycopg2와 함께 사용해야함
# * excho-True -> 실행되는 SQL문이 터미널에 출력됨(디버깅에 유용)
# -------------------------
...
# --------------------------
# 이 파일을 직접 실행하면 reset_detabade 힘수기 실행된다.
# -------------------------
